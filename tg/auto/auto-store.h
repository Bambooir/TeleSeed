...
int store_constructor_bot_inline_message_media_auto (struct paramed_type *T);
int store_constructor_bot_inline_message_text (struct paramed_type *T);
int store_constructor_bot_inline_media_result_document (struct paramed_type *T);
int store_constructor_bot_inline_media_result_photo (struct paramed_type *T);
int store_constructor_bot_inline_result (struct paramed_type *T);
int store_constructor_bytes (struct paramed_type *T);
int store_constructor_channel_messages_filter_empty (struct paramed_type *T);
int store_constructor_channel_messages_filter (struct paramed_type *T);
int store_constructor_channel_messages_filter_collapsed (struct paramed_type *T);
int store_constructor_channel_participant (struct paramed_type *T);
int store_constructor_channel_participant_self (struct paramed_type *T);
int store_constructor_channel_participant_moderator (struct paramed_type *T);
int store_constructor_channel_participant_editor (struct paramed_type *T);
int store_constructor_channel_participant_kicked (struct paramed_type *T);
int store_constructor_channel_participant_creator (struct paramed_type *T);
int store_constructor_channel_role_empty (struct paramed_type *T);
int store_constructor_channel_role_moderator (struct paramed_type *T);
int store_constructor_channel_role_editor (struct paramed_type *T);
int store_constructor_channel_participants_recent (struct paramed_type *T);
int store_constructor_channel_participants_admins (struct paramed_type *T);
int store_constructor_channel_participants_kicked (struct paramed_type *T);
int store_constructor_channel_participants_bots (struct paramed_type *T);
...
int store_constructor_channel (struct paramed_type *T);
int store_constructor_channel_forbidden (struct paramed_type *T);
int store_constructor_chat_full (struct paramed_type *T);
int store_constructor_channel_full (struct paramed_type *T);
...
int store_constructor_chat_participant_creator (struct paramed_type *T);
int store_constructor_chat_participant_admin (struct paramed_type *T);
...
int store_constructor_dialog_channel (struct paramed_type *T);
...
int store_constructor_found_gif (struct paramed_type *T);
int store_constructor_found_gif_cached (struct paramed_type *T);
...
int store_constructor_input_bot_inline_message_media_auto (struct paramed_type *T);
int store_constructor_input_bot_inline_message_text (struct paramed_type *T);
int store_constructor_input_bot_inline_result (struct paramed_type *T);
int store_constructor_input_channel_empty (struct paramed_type *T);
int store_constructor_input_channel (struct paramed_type *T);
...
int store_constructor_input_media_gif_external (struct paramed_type *T);
...
int store_constructor_input_peer_user (struct paramed_type *T);
int store_constructor_input_peer_channel (struct paramed_type *T);
...
int store_constructor_input_user (struct paramed_type *T);
...
int store_constructor_message_action_channel_create (struct paramed_type *T);
int store_constructor_message_action_chat_migrate_to (struct paramed_type *T);
int store_constructor_message_action_channel_migrate_from (struct paramed_type *T);
int store_constructor_message_entity_unknown (struct paramed_type *T);
int store_constructor_message_entity_mention (struct paramed_type *T);
int store_constructor_message_entity_hashtag (struct paramed_type *T);
int store_constructor_message_entity_bot_command (struct paramed_type *T);
int store_constructor_message_entity_url (struct paramed_type *T);
int store_constructor_message_entity_email (struct paramed_type *T);
int store_constructor_message_entity_bold (struct paramed_type *T);
int store_constructor_message_entity_italic (struct paramed_type *T);
int store_constructor_message_entity_code (struct paramed_type *T);
int store_constructor_message_entity_pre (struct paramed_type *T);
int store_constructor_message_entity_text_url (struct paramed_type *T);
int store_constructor_message_group (struct paramed_type *T);
...
int store_constructor_message_range (struct paramed_type *T);
...
int store_constructor_input_messages_filter_audio_documents (struct paramed_type *T);
int store_constructor_input_messages_filter_url (struct paramed_type *T);
int store_constructor_input_messages_filter_gif (struct paramed_type *T);
...
int store_constructor_peer_channel (struct paramed_type *T);
...
int store_constructor_input_report_reason_spam (struct paramed_type *T);
int store_constructor_input_report_reason_violence (struct paramed_type *T);
int store_constructor_input_report_reason_pornography (struct paramed_type *T);
int store_constructor_input_report_reason_other (struct paramed_type *T);
...
int store_constructor_true (struct paramed_type *T);
...
int store_constructor_update_channel_too_long (struct paramed_type *T);
int store_constructor_update_channel (struct paramed_type *T);
int store_constructor_update_channel_group (struct paramed_type *T);
int store_constructor_update_new_channel_message (struct paramed_type *T);
int store_constructor_update_read_channel_inbox (struct paramed_type *T);
int store_constructor_update_delete_channel_messages (struct paramed_type *T);
int store_constructor_update_channel_message_views (struct paramed_type *T);
int store_constructor_update_chat_admins (struct paramed_type *T);
int store_constructor_update_chat_participant_admin (struct paramed_type *T);
int store_constructor_update_new_sticker_set (struct paramed_type *T);
int store_constructor_update_sticker_sets_order (struct paramed_type *T);
int store_constructor_update_sticker_sets (struct paramed_type *T);
int store_constructor_update_saved_gifs (struct paramed_type *T);
int store_constructor_update_bot_inline_query (struct paramed_type *T);
...
int store_constructor_update_short_sent_message (struct paramed_type *T);
...
int store_constructor_binlog_peer (struct paramed_type *T);
int store_constructor_binlog_peer_user (struct paramed_type *T);
int store_constructor_binlog_peer_chat (struct paramed_type *T);
int store_constructor_binlog_peer_channel (struct paramed_type *T);
...
int store_constructor_binlog_peer_delete (struct paramed_type *T);
int store_constructor_binlog_encr_chat (struct paramed_type *T);
int store_constructor_binlog_encr_chat_exchange (struct paramed_type *T);
int store_constructor_binlog_user (struct paramed_type *T);
int store_constructor_binlog_chat (struct paramed_type *T);
int store_constructor_binlog_channel (struct paramed_type *T);
...
int store_constructor_channels_channel_participant (struct paramed_type *T);
int store_constructor_channels_channel_participants (struct paramed_type *T);
...
int store_constructor_contacts_resolved_peer (struct paramed_type *T);
int store_constructor_contacts_suggested (struct paramed_type *T);
int store_constructor_help_app_changelog_empty (struct paramed_type *T);
int store_constructor_help_app_changelog (struct paramed_type *T);
...
int store_constructor_help_terms_of_service (struct paramed_type *T);
...
int store_constructor_messages_bot_results (struct paramed_type *T);
...
int store_constructor_messages_found_gifs (struct paramed_type *T);
...
int store_constructor_messages_channel_messages (struct paramed_type *T);
int store_constructor_messages_saved_gifs_not_modified (struct paramed_type *T);
int store_constructor_messages_saved_gifs (struct paramed_type *T);
...
int store_constructor_updates_channel_difference_empty (struct paramed_type *T);
int store_constructor_updates_channel_difference_too_long (struct paramed_type *T);
int store_constructor_updates_channel_difference (struct paramed_type *T);
...
int store_type_bot_inline_message (struct paramed_type *T);
int store_type_bare_bot_inline_message (struct paramed_type *T);
int store_type_bot_inline_result (struct paramed_type *T);
int store_type_bare_bot_inline_result (struct paramed_type *T);
int store_type_bytes (struct paramed_type *T);
int store_type_bare_bytes (struct paramed_type *T);
int store_type_channel_messages_filter (struct paramed_type *T);
int store_type_bare_channel_messages_filter (struct paramed_type *T);
int store_type_channel_participant (struct paramed_type *T);
int store_type_bare_channel_participant (struct paramed_type *T);
int store_type_channel_participant_role (struct paramed_type *T);
int store_type_bare_channel_participant_role (struct paramed_type *T);
int store_type_channel_participants_filter (struct paramed_type *T);
int store_type_bare_channel_participants_filter (struct paramed_type *T);
...
int store_type_found_gif (struct paramed_type *T);
int store_type_bare_found_gif (struct paramed_type *T);
...
int store_type_input_bot_inline_message (struct paramed_type *T);
int store_type_bare_input_bot_inline_message (struct paramed_type *T);
int store_type_input_bot_inline_result (struct paramed_type *T);
int store_type_bare_input_bot_inline_result (struct paramed_type *T);
int store_type_input_channel (struct paramed_type *T);
int store_type_bare_input_channel (struct paramed_type *T);
...
int store_type_message_entity (struct paramed_type *T);
int store_type_bare_message_entity (struct paramed_type *T);
int store_type_message_group (struct paramed_type *T);
int store_type_bare_message_group (struct paramed_type *T);
int store_type_message_media (struct paramed_type *T);
int store_type_bare_message_media (struct paramed_type *T);
int store_type_message_range (struct paramed_type *T);
int store_type_bare_message_range (struct paramed_type *T);
...
int store_type_report_reason (struct paramed_type *T);
int store_type_bare_report_reason (struct paramed_type *T);
...
int store_type_true (struct paramed_type *T);
int store_type_bare_true (struct paramed_type *T);
...
int store_type_binlog_peer (struct paramed_type *T);
int store_type_bare_binlog_peer (struct paramed_type *T);
int store_type_binlog_peer_type (struct paramed_type *T);
int store_type_bare_binlog_peer_type (struct paramed_type *T);
int store_type_binlog_update (struct paramed_type *T);
int store_type_bare_binlog_update (struct paramed_type *T);
int store_type_channels_channel_participant (struct paramed_type *T);
int store_type_bare_channels_channel_participant (struct paramed_type *T);
int store_type_channels_channel_participants (struct paramed_type *T);
int store_type_bare_channels_channel_participants (struct paramed_type *T);
...
int store_type_contacts_resolved_peer (struct paramed_type *T);
int store_type_bare_contacts_resolved_peer (struct paramed_type *T);
int store_type_contacts_suggested (struct paramed_type *T);
int store_type_bare_contacts_suggested (struct paramed_type *T);
int store_type_help_app_changelog (struct paramed_type *T);
int store_type_bare_help_app_changelog (struct paramed_type *T);
...
int store_type_help_terms_of_service (struct paramed_type *T);
int store_type_bare_help_terms_of_service (struct paramed_type *T);
...
int store_type_messages_bot_results (struct paramed_type *T);
int store_type_bare_messages_bot_results (struct paramed_type *T);
...
int store_type_messages_found_gifs (struct paramed_type *T);
int store_type_bare_messages_found_gifs (struct paramed_type *T);
int store_type_messages_messages (struct paramed_type *T);
int store_type_bare_messages_messages (struct paramed_type *T);
int store_type_messages_saved_gifs (struct paramed_type *T);
int store_type_bare_messages_saved_gifs (struct paramed_type *T);
...
int store_type_updates_channel_difference (struct paramed_type *T);
int store_type_bare_updates_channel_difference (struct paramed_type *T);
...
struct paramed_type *store_function_account_report_peer (void);
...
struct paramed_type *store_function_channels_check_username (void);
struct paramed_type *store_function_channels_create_channel (void);
struct paramed_type *store_function_channels_delete_channel (void);
struct paramed_type *store_function_channels_delete_messages (void);
struct paramed_type *store_function_channels_delete_user_history (void);
struct paramed_type *store_function_channels_edit_about (void);
struct paramed_type *store_function_channels_edit_admin (void);
struct paramed_type *store_function_channels_edit_photo (void);
struct paramed_type *store_function_channels_edit_title (void);
struct paramed_type *store_function_channels_export_invite (void);
struct paramed_type *store_function_channels_get_channels (void);
struct paramed_type *store_function_channels_get_dialogs (void);
struct paramed_type *store_function_channels_get_full_channel (void);
struct paramed_type *store_function_channels_get_important_history (void);
struct paramed_type *store_function_channels_get_messages (void);
struct paramed_type *store_function_channels_get_participant (void);
struct paramed_type *store_function_channels_get_participants (void);
struct paramed_type *store_function_channels_invite_to_channel (void);
struct paramed_type *store_function_channels_join_channel (void);
struct paramed_type *store_function_channels_kick_from_channel (void);
struct paramed_type *store_function_channels_leave_channel (void);
struct paramed_type *store_function_channels_read_history (void);
struct paramed_type *store_function_channels_report_spam (void);
struct paramed_type *store_function_channels_toggle_comments (void);
struct paramed_type *store_function_channels_update_username (void);
...
struct paramed_type *store_function_help_get_app_changelog (void);
...
struct paramed_type *store_function_help_get_terms_of_service (void);
...
struct paramed_type *store_function_messages_edit_chat_admin (void);
...
struct paramed_type *store_function_messages_get_document_by_hash (void);
...
struct paramed_type *store_function_messages_get_inline_bot_results (void);
struct paramed_type *store_function_messages_get_messages (void);
struct paramed_type *store_function_messages_get_messages_views (void);
struct paramed_type *store_function_messages_get_saved_gifs (void);
...
struct paramed_type *store_function_messages_migrate_chat (void);
...
struct paramed_type *store_function_messages_reorder_sticker_sets (void);
struct paramed_type *store_function_messages_report_spam (void);
struct paramed_type *store_function_messages_request_encryption (void);
struct paramed_type *store_function_messages_save_gif (void);
struct paramed_type *store_function_messages_search (void);
struct paramed_type *store_function_messages_search_gifs (void);
struct paramed_type *store_function_messages_search_global (void);
...
struct paramed_type *store_function_messages_send_inline_bot_result (void);
...
struct paramed_type *store_function_messages_set_inline_bot_results (void);
struct paramed_type *store_function_messages_set_typing (void);
struct paramed_type *store_function_messages_start_bot (void);
struct paramed_type *store_function_messages_toggle_chat_admins (void);
...
struct paramed_type *store_function_updates_get_channel_difference (void);
