...
int fetch_constructor_bot_inline_message_text (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 0)) {
    ...
    if (fetch_type_bare_true (field2) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (multiline_output >= 2) { print_offset (); }
...
int fetch_constructor_bot_inline_media_result_document (struct paramed_type *T) {
  ...
  if (fetch_type_document (field3) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  ...
  if (fetch_type_bot_inline_message (field4) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
...
int fetch_constructor_bot_inline_result (struct paramed_type *T) {
  ...
  if (fetch_type_bot_inline_message (field13) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
...
int fetch_constructor_channel_messages_filter (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 1)) {
    ...
    if (fetch_type_bare_true (field3) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (multiline_output >= 2) { print_offset (); }
...
int fetch_constructor_chat (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 2)) {
    ...
    if (fetch_type_bare_true (field4) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 3)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_bare_true (field5) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 4)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_bare_true (field6) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 5)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_bare_true (field7) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" id :"); }
  ...
  if (fetch_type_chat_photo (field10) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  ...
  if (PTR2INT (var0) & (1 << 6)) {
    ...
    if (fetch_type_input_channel (field14) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  return 0;
}
...
int fetch_constructor_channel (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 7)) {
    ...
    if (fetch_type_bare_true (field8) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 8)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_bare_true (field9) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 9)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_bare_true (field10) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" id :"); }
  ...
  if (fetch_type_bare_long (field12) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" title :"); }
  struct paramed_type *field13 = 
  ...
  if (PTR2INT (var0) & (1 << 6)) {
    ...
    if (fetch_type_bare_string (field14) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" photo :"); }
  ...
  if (fetch_type_chat_photo (field15) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" date :"); }
  ...
  if (PTR2INT (var0) & (1 << 9)) {
    ...
    if (fetch_type_bare_string (field18) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  return 0;
}
...
int fetch_constructor_channel_full (struct paramed_type *T) {
  ...
  if (fetch_type_photo (field11) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" notify_settings :"); }
  struct paramed_type *field12 = 
  ...
  if (fetch_type_peer_notify_settings (field12) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" exported_invite :"); }
  struct paramed_type *field13 = 
  ...
  if (fetch_type_exported_chat_invite (field13) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" bot_info :"); }
  struct paramed_type *field14 = 
  ...
  if (fetch_type_vector (field14) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (PTR2INT (var0) & (1 << 4)) {
    if (multiline_output >= 2) { print_offset (); }
...
int fetch_constructor_chat_participants_forbidden (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 0)) {
    ...
    if (fetch_type_chat_participant (field3) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  return 0;
}
...
int fetch_constructor_config (struct paramed_type *T) {
  ...
  if (fetch_type_bare_int (field18) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  ...
  if (fetch_type_vector (field19) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
...
int fetch_constructor_dialog_channel (struct paramed_type *T) {
  ...
  if (fetch_type_peer_notify_settings (field7) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
...
int fetch_constructor_input_bot_inline_result (struct paramed_type *T) {
  ...
  if (fetch_type_input_bot_inline_message (field13) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
...
int fetch_constructor_message (struct paramed_type *T) {
  ...
  if (fetch_type_peer (field8) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (PTR2INT (var0) & (1 << 2)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_peer (field9) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 2)) {
    if (multiline_output >= 2) { print_offset (); }
  ...
  if (PTR2INT (var0) & (1 << 9)) {
    ...
    if (fetch_type_message_media (field15) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 6)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_reply_markup (field16) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 7)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_vector (field17) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
...
int fetch_constructor_message_service (struct paramed_type *T) {
  ...
  if (fetch_type_message_action (field10) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
...
int fetch_constructor_sticker_set (struct paramed_type *T) {
  ...
  if (fetch_type_bare_long (field6) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" title :"); }
  struct paramed_type *field7 = 
...
int fetch_constructor_update_channel_group (struct paramed_type *T) {
  ...
  if (fetch_type_message_group (field2) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
...
int fetch_constructor_update_new_sticker_set (struct paramed_type *T) {
  ...
  if (fetch_type_messages_sticker_set (field1) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
...
int fetch_constructor_update_short_message (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 2)) {
    ...
    if (fetch_type_peer (field12) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 2)) {
    if (multiline_output >= 2) { print_offset (); }
  ...
  if (PTR2INT (var0) & (1 << 7)) {
    ...
    if (fetch_type_vector (field16) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  return 0;
}
int fetch_constructor_update_short_chat_message (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 2)) {
    ...
    if (fetch_type_peer (field13) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 2)) {
    if (multiline_output >= 2) { print_offset (); }
...
int fetch_constructor_update_short_sent_message (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 7)) {
    ...
    if (fetch_type_vector (field9) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  return 0;
}
...
int fetch_constructor_user (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 4)) {
    ...
    if (fetch_type_bare_string (field16) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 5)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_user_profile_photo (field17) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 6)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_user_status (field18) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 14)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_bare_int (field19) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 18)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_bare_string (field20) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 19)) {
    ...
    if (fetch_type_bare_string (field21) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  return 0;
}
...
int fetch_constructor_web_page (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 9)) {
    ...
    if (fetch_type_document (field16) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  return 0;
}
...
int fetch_constructor_binlog_peer (struct paramed_type *T) {
  ...
  if (fetch_type_binlog_peer_type (field1) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
...
int fetch_constructor_binlog_peer_delete (struct paramed_type *T) {
  ...
  if (fetch_type_bare_binlog_peer (field1) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
...
int fetch_constructor_binlog_channel (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 27)) {
    ...
    if (fetch_type_bare_long (field13) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  return 0;
}
...
int fetch_constructor_binlog_message_new (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 17)) {
    ...
    if (fetch_type_bare_binlog_peer (field3) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 17)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_bare_binlog_peer (field4) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 18)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_bare_binlog_peer (field5) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 18)) {
    if (multiline_output >= 2) { print_offset (); }
  ...
  if (PTR2INT (var0) & (1 << 24)) {
    ...
    if (fetch_type_reply_markup (field12) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  return 0;
}
int fetch_constructor_binlog_message_encr_new (struct paramed_type *T) {
  ...
  if (PTR2INT (var0) & (1 << 22)) {
    ...
    if (fetch_type_decrypted_message_action (field8) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  if (PTR2INT (var0) & (1 << 23)) {
    if (multiline_output >= 2) { print_offset (); }
    ...
    if (fetch_type_encrypted_file (field9) < 0) { return -1;}
    if (multiline_output >= 2) { eprintf ("\n"); }
  }
  return 0;
}
...
int fetch_constructor_channels_channel_participant (struct paramed_type *T) {
  ...
  if (fetch_type_channel_participant (field1) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" users :"); }
  struct paramed_type *field2 = 
...
int fetch_constructor_updates_channel_difference_too_long (struct paramed_type *T) {
  ...
  if (fetch_type_vector (field10) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" chats :"); }
  struct paramed_type *field11 = 
  ...
  if (fetch_type_vector (field11) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  if (multiline_output >= 2) { print_offset (); }
  if (!disable_field_names) { eprintf (" users :"); }
  struct paramed_type *field12 = 
  ...
  if (fetch_type_vector (field12) < 0) { return -1;}
  if (multiline_output >= 2) { eprintf ("\n"); }
  return 0;
}
...
int fetch_type_audio (struct paramed_type *T) {
  ...
  case 0xf9e35055: res = fetch_constructor_audio (T); break;
  default: return -1;
  }
  if (res >= 0) {
...
int fetch_type_bare_bot_command (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_bot_command (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
...
int fetch_type_bot_inline_message (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xfc56e87d: res = fetch_constructor_bot_inline_message_media_auto (T); break;
  case 0xa56197a9: res = fetch_constructor_bot_inline_message_text (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_bot_inline_message (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_bot_inline_message_media_auto (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_bot_inline_message_media_auto (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_bot_inline_message_text (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_bot_inline_message_text (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_bot_inline_result (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xf897d33e: res = fetch_constructor_bot_inline_media_result_document (T); break;
  case 0xc5528587: res = fetch_constructor_bot_inline_media_result_photo (T); break;
  case 0x9bebaeb9: res = fetch_constructor_bot_inline_result (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_bot_inline_result (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_bot_inline_media_result_document (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_bot_inline_media_result_document (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_bot_inline_media_result_photo (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_bot_inline_media_result_photo (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_bot_inline_result (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_bot_inline_result (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_channel_messages_filter (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x94d42ee7: res = fetch_constructor_channel_messages_filter_empty (T); break;
  case 0xcd77d957: res = fetch_constructor_channel_messages_filter (T); break;
  case 0xfa01232e: res = fetch_constructor_channel_messages_filter_collapsed (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_channel_messages_filter (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_channel_messages_filter_empty (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_messages_filter_empty (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_messages_filter (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_messages_filter (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_messages_filter_collapsed (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_messages_filter_collapsed (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_channel_participant (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x15ebac1d: res = fetch_constructor_channel_participant (T); break;
  case 0xa3289a6d: res = fetch_constructor_channel_participant_self (T); break;
  case 0x91057fef: res = fetch_constructor_channel_participant_moderator (T); break;
  case 0x98192d61: res = fetch_constructor_channel_participant_editor (T); break;
  case 0x8cc5e69a: res = fetch_constructor_channel_participant_kicked (T); break;
  case 0xe3e2e1f9: res = fetch_constructor_channel_participant_creator (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_channel_participant (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_channel_participant (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_participant (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_participant_self (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_participant_self (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_participant_moderator (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_participant_moderator (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_participant_editor (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_participant_editor (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_participant_kicked (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_participant_kicked (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_participant_creator (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_participant_creator (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_channel_participant_role (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xb285a0c6: res = fetch_constructor_channel_role_empty (T); break;
  case 0x9618d975: res = fetch_constructor_channel_role_moderator (T); break;
  case 0x820bfe8c: res = fetch_constructor_channel_role_editor (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_channel_participant_role (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_channel_role_empty (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_role_empty (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_role_moderator (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_role_moderator (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_role_editor (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_role_editor (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_channel_participants_filter (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xde3f3c79: res = fetch_constructor_channel_participants_recent (T); break;
  case 0xb4608969: res = fetch_constructor_channel_participants_admins (T); break;
  case 0x3c37bb7a: res = fetch_constructor_channel_participants_kicked (T); break;
  case 0xb0d1865b: res = fetch_constructor_channel_participants_bots (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_channel_participants_filter (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_channel_participants_recent (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_participants_recent (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_participants_admins (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_participants_admins (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_participants_kicked (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_participants_kicked (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_participants_bots (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_participants_bots (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_chat (struct paramed_type *T) {
  ...
  case 0xd91cdd54: res = fetch_constructor_chat (T); break;
  case 0x07328bdb: res = fetch_constructor_chat_forbidden (T); break;
  case 0x4b1b7506: res = fetch_constructor_channel (T); break;
  case 0x2d85832c: res = fetch_constructor_channel_forbidden (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_chat (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_channel (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_forbidden (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_forbidden (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_chat_full (struct paramed_type *T) {
  ...
  case 0x9e341ddf: res = fetch_constructor_channel_full (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_chat_full (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_channel_full (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_channel_full (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_chat_invite (struct paramed_type *T) {
  ...
  case 0x93e99b60: res = fetch_constructor_chat_invite (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_chat_participant (struct paramed_type *T) {
  ...
  case 0xda13538a: res = fetch_constructor_chat_participant_creator (T); break;
  case 0xe2d6e436: res = fetch_constructor_chat_participant_admin (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_chat_participant (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_chat_participant (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_chat_participant (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_chat_participant_creator (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_chat_participant_creator (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_chat_participant_admin (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_chat_participant_admin (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_chat_participants (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xfc900c2b: res = fetch_constructor_chat_participants_forbidden (T); break;
  case 0x3f460fed: res = fetch_constructor_chat_participants (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_config (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x06bbc5f8: res = fetch_constructor_config (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_dialog (struct paramed_type *T) {
  ...
  case 0x5b8496b2: res = fetch_constructor_dialog_channel (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_dialog (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_dialog (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_dialog (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_dialog_channel (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_dialog_channel (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_document_attribute (struct paramed_type *T) {
  ...
  case 0xded218e0: res = fetch_constructor_document_attribute_audio (T); break;
...
int fetch_type_found_gif (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x162ecc1f: res = fetch_constructor_found_gif (T); break;
  case 0x9c750409: res = fetch_constructor_found_gif_cached (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_found_gif (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_found_gif (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_found_gif (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_found_gif_cached (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_found_gif_cached (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_input_bot_inline_message (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x2e43e587: res = fetch_constructor_input_bot_inline_message_media_auto (T); break;
  case 0xadf0df71: res = fetch_constructor_input_bot_inline_message_text (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_input_bot_inline_message (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_input_bot_inline_message_media_auto (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_bot_inline_message_media_auto (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_input_bot_inline_message_text (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_bot_inline_message_text (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_input_bot_inline_result (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x2cbbe15a: res = fetch_constructor_input_bot_inline_result (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_input_bot_inline_result (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_input_bot_inline_result (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
int fetch_type_input_channel (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xee8c1e86: res = fetch_constructor_input_channel_empty (T); break;
  case 0xafeb712e: res = fetch_constructor_input_channel (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_input_channel (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_input_channel_empty (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_channel_empty (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_input_channel (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_channel (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_input_media (struct paramed_type *T) {
  ...
  case 0x82713fdf: res = fetch_constructor_input_media_uploaded_video (T); break;
  case 0x7780ddf9: res = fetch_constructor_input_media_uploaded_thumb_video (T); break;
  ...
  case 0x1d89306d: res = fetch_constructor_input_media_uploaded_document (T); break;
  case 0xad613491: res = fetch_constructor_input_media_uploaded_thumb_document (T); break;
  case 0x1a77f29c: res = fetch_constructor_input_media_document (T); break;
  case 0x2827a81a: res = fetch_constructor_input_media_venue (T); break;
  case 0x4843b0fd: res = fetch_constructor_input_media_gif_external (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_input_media (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_input_media_gif_external (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_media_gif_external (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_input_peer (struct paramed_type *T) {
  ...
  case 0x7b8e7de6: res = fetch_constructor_input_peer_user (T); break;
  case 0x20adaef8: res = fetch_constructor_input_peer_channel (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_input_peer (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_input_peer_user (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_peer_user (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_input_peer_channel (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_peer_channel (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_input_user (struct paramed_type *T) {
  ...
  case 0xd8292816: res = fetch_constructor_input_user (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_input_user (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_input_user (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_user (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_message (struct paramed_type *T) {
  ...
  case 0xc992e15c: res = fetch_constructor_message (T); break;
  case 0xc06b9607: res = fetch_constructor_message_service (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_message_action (struct paramed_type *T) {
  ...
  case 0x488a7337: res = fetch_constructor_message_action_chat_add_user (T); break;
  ...
  case 0x95d2ac92: res = fetch_constructor_message_action_channel_create (T); break;
  case 0x51bdb021: res = fetch_constructor_message_action_chat_migrate_to (T); break;
  case 0xb055eaee: res = fetch_constructor_message_action_channel_migrate_from (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_message_action (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_message_action_channel_create (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_action_channel_create (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_action_chat_migrate_to (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_action_chat_migrate_to (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_action_channel_migrate_from (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_action_channel_migrate_from (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_message_entity (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xbb92ba95: res = fetch_constructor_message_entity_unknown (T); break;
  case 0xfa04579d: res = fetch_constructor_message_entity_mention (T); break;
  case 0x6f635b0d: res = fetch_constructor_message_entity_hashtag (T); break;
  case 0x6cef8ac7: res = fetch_constructor_message_entity_bot_command (T); break;
  case 0x6ed02538: res = fetch_constructor_message_entity_url (T); break;
  case 0x64e475c2: res = fetch_constructor_message_entity_email (T); break;
  case 0xbd610bc9: res = fetch_constructor_message_entity_bold (T); break;
  case 0x826f8b60: res = fetch_constructor_message_entity_italic (T); break;
  case 0x28a20571: res = fetch_constructor_message_entity_code (T); break;
  case 0x73924be0: res = fetch_constructor_message_entity_pre (T); break;
  case 0x76a6d327: res = fetch_constructor_message_entity_text_url (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_message_entity (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_message_entity_unknown (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_unknown (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_entity_mention (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_mention (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_entity_hashtag (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_hashtag (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_entity_bot_command (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_bot_command (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_entity_url (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_url (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_entity_email (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_email (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_entity_bold (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_bold (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_entity_italic (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_italic (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_entity_code (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_code (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_entity_pre (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_pre (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_message_entity_text_url (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_message_entity_text_url (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_message_group (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xe8346f53: res = fetch_constructor_message_group (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_message_group (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_message_group (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
int fetch_type_message_media (struct paramed_type *T) {
  ...
  case 0xf3e02ea8: res = fetch_constructor_message_media_document (T); break;
...
int fetch_type_message_range (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x0ae30253: res = fetch_constructor_message_range (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_message_range (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_message_range (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
int fetch_type_messages_filter (struct paramed_type *T) {
  ...
  case 0x5afbf764: res = fetch_constructor_input_messages_filter_audio_documents (T); break;
  case 0x7ef0dd87: res = fetch_constructor_input_messages_filter_url (T); break;
  case 0xffc86587: res = fetch_constructor_input_messages_filter_gif (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_messages_filter (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_input_messages_filter_audio_documents (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_messages_filter_audio_documents (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_input_messages_filter_url (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_messages_filter_url (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_input_messages_filter_gif (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_messages_filter_gif (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_peer (struct paramed_type *T) {
  ...
  case 0xbddde532: res = fetch_constructor_peer_channel (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_peer (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_peer_channel (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_peer_channel (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_photo (struct paramed_type *T) {
  ...
  case 0xcded42fe: res = fetch_constructor_photo (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_report_reason (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x58dbcab8: res = fetch_constructor_input_report_reason_spam (T); break;
  case 0x1e22c78d: res = fetch_constructor_input_report_reason_violence (T); break;
  case 0x2e59d922: res = fetch_constructor_input_report_reason_pornography (T); break;
  case 0xe1746d0a: res = fetch_constructor_input_report_reason_other (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_report_reason (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_input_report_reason_spam (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_report_reason_spam (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_input_report_reason_violence (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_report_reason_violence (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_input_report_reason_pornography (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_report_reason_pornography (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_input_report_reason_other (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_input_report_reason_other (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_sticker_set (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xcd303b41: res = fetch_constructor_sticker_set (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_true (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x3fedd339: res = fetch_constructor_true (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_true (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_true (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
int fetch_type_update (struct paramed_type *T) {
  ...
  case 0xea4b0e5c: res = fetch_constructor_update_chat_participant_add (T); break;
  ...
  case 0x7f891213: res = fetch_constructor_update_web_page (T); break;
  case 0x68c13933: res = fetch_constructor_update_read_messages_contents (T); break;
  case 0x60946422: res = fetch_constructor_update_channel_too_long (T); break;
  case 0xb6d45656: res = fetch_constructor_update_channel (T); break;
  case 0xc36c1e3c: res = fetch_constructor_update_channel_group (T); break;
  case 0x62ba04d9: res = fetch_constructor_update_new_channel_message (T); break;
  case 0x4214f37f: res = fetch_constructor_update_read_channel_inbox (T); break;
  case 0xc37521c9: res = fetch_constructor_update_delete_channel_messages (T); break;
  case 0x98a12b4b: res = fetch_constructor_update_channel_message_views (T); break;
  case 0x6e947941: res = fetch_constructor_update_chat_admins (T); break;
  case 0xb6901959: res = fetch_constructor_update_chat_participant_admin (T); break;
  case 0x688a30aa: res = fetch_constructor_update_new_sticker_set (T); break;
  case 0xf0dfb451: res = fetch_constructor_update_sticker_sets_order (T); break;
  case 0x43ae3dec: res = fetch_constructor_update_sticker_sets (T); break;
  case 0x9375341e: res = fetch_constructor_update_saved_gifs (T); break;
  case 0xc01eea08: res = fetch_constructor_update_bot_inline_query (T); break;
...
int fetch_type_bare_update (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_update_channel_too_long (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_channel_too_long (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_channel (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_channel (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_channel_group (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_channel_group (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_new_channel_message (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_new_channel_message (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_read_channel_inbox (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_read_channel_inbox (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_delete_channel_messages (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_delete_channel_messages (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_channel_message_views (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_channel_message_views (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_chat_admins (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_chat_admins (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_chat_participant_admin (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_chat_participant_admin (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_new_sticker_set (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_new_sticker_set (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_sticker_sets_order (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_sticker_sets_order (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_sticker_sets (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_sticker_sets (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_saved_gifs (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_saved_gifs (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_update_bot_inline_query (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_bot_inline_query (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
...
int fetch_type_updates (struct paramed_type *T) {
  ...
  case 0x13e4deaa: res = fetch_constructor_update_short_message (T); break;
  case 0x248afa62: res = fetch_constructor_update_short_chat_message (T); break;
  ...
  case 0x11f1331c: res = fetch_constructor_update_short_sent_message (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_updates (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_update_short_sent_message (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_update_short_sent_message (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_user (struct paramed_type *T) {
  ...
  case 0xd10d979a: res = fetch_constructor_user (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_video (struct paramed_type *T) {
  ...
  case 0xf72887d3: res = fetch_constructor_video (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_web_page (struct paramed_type *T) {
  ...
  case 0xca820ed7: res = fetch_constructor_web_page (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_binlog_peer (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x381af606: res = fetch_constructor_binlog_peer (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_binlog_peer (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_binlog_peer (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
int fetch_type_binlog_peer_type (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x7777bc74: res = fetch_constructor_binlog_peer_user (T); break;
  case 0x6a48d586: res = fetch_constructor_binlog_peer_chat (T); break;
  case 0xfdfabb06: res = fetch_constructor_binlog_peer_channel (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_binlog_peer_type (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_binlog_peer_user (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_binlog_peer_user (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_binlog_peer_chat (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_binlog_peer_chat (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_binlog_peer_channel (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_binlog_peer_channel (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_binlog_update (struct paramed_type *T) {
  ...
  case 0xc6927307: res = fetch_constructor_binlog_dc_option (T); break;
  ...
  case 0xe7ccc164: res = fetch_constructor_binlog_peer_delete (T); break;
  case 0x84977251: res = fetch_constructor_binlog_encr_chat (T); break;
  case 0x9d49488d: res = fetch_constructor_binlog_encr_chat_exchange (T); break;
  case 0x127cf2f9: res = fetch_constructor_binlog_user (T); break;
  case 0x0a10aa92: res = fetch_constructor_binlog_chat (T); break;
  case 0xa98a3d98: res = fetch_constructor_binlog_channel (T); break;
...
int fetch_type_bare_binlog_update (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_binlog_peer_delete (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_binlog_peer_delete (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_binlog_encr_chat (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_binlog_encr_chat (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_binlog_encr_chat_exchange (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_binlog_encr_chat_exchange (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_binlog_user (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_binlog_user (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_binlog_chat (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_binlog_chat (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_binlog_channel (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_binlog_channel (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
...
int fetch_type_channels_channel_participant (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xd0d9b163: res = fetch_constructor_channels_channel_participant (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_channels_channel_participant (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_channels_channel_participant (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
int fetch_type_channels_channel_participants (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xf56ee2a8: res = fetch_constructor_channels_channel_participants (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_channels_channel_participants (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_channels_channel_participants (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
...
int fetch_type_contacts_found (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x1aa1f784: res = fetch_constructor_contacts_found (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_contacts_resolved_peer (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x7f077ad9: res = fetch_constructor_contacts_resolved_peer (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_contacts_resolved_peer (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_contacts_resolved_peer (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
...
int fetch_type_help_app_changelog (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xaf7e0394: res = fetch_constructor_help_app_changelog_empty (T); break;
  case 0x4668e6bd: res = fetch_constructor_help_app_changelog (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_help_app_changelog (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_help_app_changelog_empty (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_help_app_changelog_empty (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_help_app_changelog (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_help_app_changelog (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_help_terms_of_service (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xf1ee3e90: res = fetch_constructor_help_terms_of_service (T); break;
  default: return -1;
  }
  return res;
}
int fetch_type_bare_help_terms_of_service (struct paramed_type *T) {
  if (fetch_constructor_help_terms_of_service (T) >= 0) { return 0; }
  return -1;
}
...
int fetch_type_messages_all_stickers (struct paramed_type *T) {
  ...
  case 0xedfd405f: res = fetch_constructor_messages_all_stickers (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_messages_bot_results (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x1170b0a3: res = fetch_constructor_messages_bot_results (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_messages_bot_results (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_messages_bot_results (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
...
int fetch_type_messages_found_gifs (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x450a1c0a: res = fetch_constructor_messages_found_gifs (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_messages_found_gifs (struct paramed_type *T) {
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  eprintf (" (");
  if (fetch_constructor_messages_found_gifs (T) >= 0) { if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  return -1;
}
int fetch_type_messages_messages (struct paramed_type *T) {
  ...
  case 0xbc0f17bc: res = fetch_constructor_messages_channel_messages (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_messages_messages (struct paramed_type *T) {
  ...
  in_ptr = save_in_ptr;
  if (skip_constructor_messages_channel_messages (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_messages_channel_messages (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
int fetch_type_messages_saved_gifs (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0xe8025ca2: res = fetch_constructor_messages_saved_gifs_not_modified (T); break;
  case 0x2e0709a5: res = fetch_constructor_messages_saved_gifs (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_messages_saved_gifs (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_messages_saved_gifs_not_modified (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_messages_saved_gifs_not_modified (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_messages_saved_gifs (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_messages_saved_gifs (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_updates_channel_difference (struct paramed_type *T) {
  ...
  int res = -1;
  switch (magic) {
  case 0x3e11affb: res = fetch_constructor_updates_channel_difference_empty (T); break;
  case 0x5e167646: res = fetch_constructor_updates_channel_difference_too_long (T); break;
  case 0x2064674e: res = fetch_constructor_updates_channel_difference (T); break;
  default: return -1;
  }
  if (res >= 0) {
    if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); }
...
int fetch_type_bare_updates_channel_difference (struct paramed_type *T) {
  int *save_in_ptr = in_ptr;
  if (multiline_output >= 2) { multiline_offset += multiline_offset_size; }
  if (skip_constructor_updates_channel_difference_empty (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_updates_channel_difference_empty (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_updates_channel_difference_too_long (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_updates_channel_difference_too_long (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  if (skip_constructor_updates_channel_difference (T) >= 0) { in_ptr = save_in_ptr; eprintf (" ("); assert (!fetch_constructor_updates_channel_difference (T)); if (multiline_output >= 2) { multiline_offset -= multiline_offset_size; print_offset (); } eprintf (" )");return 0; }
  in_ptr = save_in_ptr;
  return -1;
}
...
int fetch_type_any (struct paramed_type *T) {
  ...
  case 0xa18ad88d: return fetch_type_audio (T);
  case 0x5e752772: return fetch_type_bare_audio (T);
  ...
  case 0xc27ac8c7: return fetch_type_bot_command (T);
  case 0x3d853738: return fetch_type_bare_bot_command (T);
  case 0xb2e16f93: return fetch_type_bot_info (T);
  case 0x4d1e906c: return fetch_type_bare_bot_info (T);
  case 0x59377fd4: return fetch_type_bot_inline_message (T);
  case 0xa6c8802b: return fetch_type_bare_bot_inline_message (T);
  case 0xa62ef800: return fetch_type_bot_inline_result (T);
  case 0x59d107ff: return fetch_type_bare_bot_inline_result (T);
  case 0x0ee1379f: return fetch_type_bytes (T);
  case 0xf11ec860: return fetch_type_bare_bytes (T);
  case 0xa3a2d49e: return fetch_type_channel_messages_filter (T);
  case 0x5c5d2b61: return fetch_type_bare_channel_messages_filter (T);
  case 0xd0f8639d: return fetch_type_channel_participant (T);
  case 0x2f079c62: return fetch_type_bare_channel_participant (T);
  case 0xa696873f: return fetch_type_channel_participant_role (T);
  case 0x596978c0: return fetch_type_bare_channel_participant_role (T);
  case 0xe6b98831: return fetch_type_channel_participants_filter (T);
  case 0x194677ce: return fetch_type_bare_channel_participants_filter (T);
  case 0x231278a5: return fetch_type_chat (T);
  case 0xdced875a: return fetch_type_bare_chat (T);
  case 0xb036bbcb: return fetch_type_chat_full (T);
  case 0x4fc94434: return fetch_type_bare_chat_full (T);
  case 0xc981f61c: return fetch_type_chat_invite (T);
  case 0x367e09e3: return fetch_type_bare_chat_invite (T);
  case 0xf012fe82: return fetch_type_chat_participant (T);
  case 0x0fed017d: return fetch_type_bare_chat_participant (T);
  case 0xc3d603c6: return fetch_type_chat_participants (T);
  case 0x3c29fc39: return fetch_type_bare_chat_participants (T);
  ...
  case 0x06bbc5f8: return fetch_type_config (T);
  case 0xf9443a07: return fetch_type_bare_config (T);
  ...
  case 0x05d8c6cc: return fetch_type_dc_option (T);
  case 0xfa273933: return fetch_type_bare_dc_option (T);
  ...
  case 0x9a5916f8: return fetch_type_dialog (T);
  case 0x65a6e907: return fetch_type_bare_dialog (T);
  case 0xae636f24: return fetch_type_disabled_feature (T);
  case 0x519c90db: return fetch_type_bare_disabled_feature (T);
  case 0xcf5b573e: return fetch_type_document (T);
  case 0x30a4a8c1: return fetch_type_bare_document (T);
  case 0xd54cff24: return fetch_type_document_attribute (T);
  case 0x2ab300db: return fetch_type_bare_document_attribute (T);
  ...
  case 0x8a5bc816: return fetch_type_found_gif (T);
  case 0x75a437e9: return fetch_type_bare_found_gif (T);
  ...
  case 0x83b33af6: return fetch_type_input_bot_inline_message (T);
  case 0x7c4cc509: return fetch_type_bare_input_bot_inline_message (T);
  case 0x2cbbe15a: return fetch_type_input_bot_inline_result (T);
  case 0xd3441ea5: return fetch_type_bare_input_bot_inline_result (T);
  case 0x41676fa8: return fetch_type_input_channel (T);
  case 0xbe989057: return fetch_type_bare_input_channel (T);
  ...
  case 0xbceee1b9: return fetch_type_input_media (T);
  case 0x43111e46: return fetch_type_bare_input_media (T);
  case 0x4f3b4fd3: return fetch_type_input_notify_peer (T);
  case 0xb0c4b02c: return fetch_type_bare_input_notify_peer (T);
  case 0x4e235d5e: return fetch_type_input_peer (T);
  case 0xb1dca2a1: return fetch_type_bare_input_peer (T);
  ...
  case 0x96601fe6: return fetch_type_input_user (T);
  case 0x699fe019: return fetch_type_bare_input_user (T);
  ...
  case 0x8a1ca90f: return fetch_type_message (T);
  case 0x75e356f0: return fetch_type_bare_message (T);
  case 0x39c6b1b9: return fetch_type_message_action (T);
  case 0xc6394e46: return fetch_type_bare_message_action (T);
  case 0x5ab67127: return fetch_type_message_entity (T);
  case 0xa5498ed8: return fetch_type_bare_message_entity (T);
  case 0xe8346f53: return fetch_type_message_group (T);
  case 0x17cb90ac: return fetch_type_bare_message_group (T);
  case 0x49c84bb6: return fetch_type_message_media (T);
  case 0xb637b449: return fetch_type_bare_message_media (T);
  case 0x0ae30253: return fetch_type_message_range (T);
  case 0xf51cfdac: return fetch_type_bare_message_range (T);
  case 0x5b4a1584: return fetch_type_messages_filter (T);
  case 0xa4b5ea7b: return fetch_type_bare_messages_filter (T);
  ...
  case 0x9abcbce4: return fetch_type_peer (T);
  case 0x6543431b: return fetch_type_bare_peer (T);
  ...
  case 0xeedcf0d3: return fetch_type_photo (T);
  case 0x11230f2c: return fetch_type_bare_photo (T);
  ...
  case 0x89d4b91d: return fetch_type_report_reason (T);
  case 0x762b46e2: return fetch_type_bare_report_reason (T);
  case 0x05162463: return fetch_type_res_p_q (T);
  case 0xfae9db9c: return fetch_type_bare_res_p_q (T);
  case 0x8b525068: return fetch_type_send_message_action (T);
  case 0x74adaf97: return fetch_type_bare_send_message_action (T);
  ...
  case 0xcd303b41: return fetch_type_sticker_set (T);
  case 0x32cfc4be: return fetch_type_bare_sticker_set (T);
  case 0xb5286e24: return fetch_type_string (T);
  case 0x4ad791db: return fetch_type_bare_string (T);
  case 0x3fedd339: return fetch_type_true (T);
  case 0xc0122cc6: return fetch_type_bare_true (T);
  case 0xc9a719e0: return fetch_type_update (T);
  case 0x3658e61f: return fetch_type_bare_update (T);
  case 0xbba920e8: return fetch_type_updates (T);
  case 0x4456df17: return fetch_type_bare_updates (T);
  case 0xf10fc720: return fetch_type_user (T);
  case 0x0ef038df: return fetch_type_bare_user (T);
  ...
  case 0x362edf7b: return fetch_type_video (T);
  case 0xc9d12084: return fetch_type_bare_video (T);
  case 0xafa14973: return fetch_type_wall_paper (T);
  case 0x505eb68c: return fetch_type_bare_wall_paper (T);
  case 0xe410a323: return fetch_type_web_page (T);
  case 0x1bef5cdc: return fetch_type_bare_web_page (T);
  ...
  case 0x381af606: return fetch_type_binlog_peer (T);
  case 0xc7e509f9: return fetch_type_bare_binlog_peer (T);
  case 0xe0c5d2f4: return fetch_type_binlog_peer_type (T);
  case 0x1f3a2d0b: return fetch_type_bare_binlog_peer_type (T);
  case 0x2907a918: return fetch_type_binlog_update (T);
  case 0xd6f856e7: return fetch_type_bare_binlog_update (T);
  case 0xd0d9b163: return fetch_type_channels_channel_participant (T);
  case 0x2f264e9c: return fetch_type_bare_channels_channel_participant (T);
  case 0xf56ee2a8: return fetch_type_channels_channel_participants (T);
  case 0x0a911d57: return fetch_type_bare_channels_channel_participants (T);
  ...
  case 0x1aa1f784: return fetch_type_contacts_found (T);
  case 0xe55e087b: return fetch_type_bare_contacts_found (T);
  ...
  case 0x7f077ad9: return fetch_type_contacts_resolved_peer (T);
  case 0x80f88526: return fetch_type_bare_contacts_resolved_peer (T);
  case 0x5649dcc5: return fetch_type_contacts_suggested (T);
  case 0xa9b6233a: return fetch_type_bare_contacts_suggested (T);
  case 0xe916e529: return fetch_type_help_app_changelog (T);
  case 0x16e91ad6: return fetch_type_bare_help_app_changelog (T);
  ...
  case 0xf1ee3e90: return fetch_type_help_terms_of_service (T);
  case 0x0e11c16f: return fetch_type_bare_help_terms_of_service (T);
  ...
  case 0x059b429c: return fetch_type_messages_all_stickers (T);
  case 0xfa64bd63: return fetch_type_bare_messages_all_stickers (T);
  case 0x1170b0a3: return fetch_type_messages_bot_results (T);
  case 0xee8f4f5c: return fetch_type_bare_messages_bot_results (T);
  ...
  case 0x450a1c0a: return fetch_type_messages_found_gifs (T);
  case 0xbaf5e3f5: return fetch_type_bare_messages_found_gifs (T);
  case 0x3b3af3d8: return fetch_type_messages_messages (T);
  case 0xc4c50c27: return fetch_type_bare_messages_messages (T);
  case 0xc6055507: return fetch_type_messages_saved_gifs (T);
  case 0x39faaaf8: return fetch_type_bare_messages_saved_gifs (T);
  ...
  case 0x4063bef3: return fetch_type_updates_channel_difference (T);
  case 0xbf9c410c: return fetch_type_bare_updates_channel_difference (T);
